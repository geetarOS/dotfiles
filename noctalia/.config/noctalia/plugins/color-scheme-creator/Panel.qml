  ...
  function generateTerminalColors(variant) {
    ...
    return {
      normal: {
        ...
        green: Qt.color(variant.mOutline).toString().toUpperCase(),
        yellow: Qt.color(variant.mHover).toString().toUpperCase(),
      ...
      bright: {
        ...
        green: brighten(variant.mOutline),
        yellow: brighten(variant.mHover),
